    ...
    return (
        <div className="mx-auto my-10 w-10/12">
            ...
            <div className="flex items-center">
                <form onSubmit={handleSubmit(onSubmit)} className="w-2/3 mx-8 bg-violet-50 p-16 rounded-3xl border border-violet-200">
                <h1 className="mx-auto text-center text-[45px] font-bold mb-6">Sign In to Your Account</h1>
                    ...
                    <button onClick={handleGoogleSignin} className="btn ml-2 bg-blue-200"><FcGoogle /> Sign In with Google</button>
