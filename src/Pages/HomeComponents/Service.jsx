    ...
    return (
        <div className="flex items-start gap-2 bg-green-100 rounded-2xl p-3">
            ...
            <div className="w-2/3 space-y-2">
                ...
                <Link to={`/allservices/${_id}`} className="btn text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 mt-auto">See Details</Link>
            </div>
        </div>
    );
};
