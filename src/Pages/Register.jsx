...
const Register = () => {
    ...
    return (
        <div className="mx-auto my-10 w-10/12">
            <h1 className="mx-auto text-center text-[45px] font-bold mb-6">Create Your Account</h1>
            <div className="flex items-center">
                <form onSubmit={handleSubmit(onSubmit)} className="w-2/3 mx-8 bg-cyan-50 p-16 rounded-3xl border border-cyan-200">
